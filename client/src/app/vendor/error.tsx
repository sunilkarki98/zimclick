  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-2">Vendor Dashboard Error</h2>
        <p className="text-sm text-gray-500 mb-6">{error.message || "An unexpected error occurred in the vendor dashboard."}</p>
        <button
          onClick={reset}
